...
$planos[] = array(
	'numero'          => 1,
	'title'           => 'Plano 1',
	'subtitulo'       => 'Texto Plano 1',
	'caracteristica1' => 'Plano 1 caracteristica 1',
	'caracteristica2' => 'Plano 1 caracteristica 2',
	'caracteristica3' => 'Plano 1 caracteristica 3',
	'preco'           => 'R$100,00',
);
...
$planos[] = array(
	'numero'          => 2,
	'title'           => 'Plano 2',
	'subtitulo'       => 'Texto Plano 2',
	'caracteristica1' => 'Plano 2 caracteristica 1',
	'caracteristica2' => 'Plano 2 caracteristica 2',
	'caracteristica3' => 'Plano 2 caracteristica 3',
	'preco'           => 'R$200,00',
);
...
$planos[] = array(
	'numero'          => 3,
	'title'           => 'Plano 3',
	'subtitulo'       => 'Texto Plano 3',
	'caracteristica1' => 'Plano 3 caracteristica 1',
	'caracteristica2' => 'Plano 3 caracteristica 2',
	'caracteristica3' => 'Plano 3 caracteristica 3',
	'preco'           => 'R$300,00',
);
		  ...
		  <header id="header">
		    <div class="container main-menu">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="index.php"><img src="img/logo-maxisite.png" alt="" title="" /></a>
			      </div>
				...
				<div class="container">
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-lg-5 col-md-6 home-about-right">
							<h6>Elton Leão</h6>
							<h1 class="text-uppercase">Texto explicativo</h1>
							<p>
								A primeira linguagem com qual eu tive contato foi Python, e com o amor a primeira vista à lógica de programação, continuei estudando por conta própria até encontrar a programação web com javascript.
								Nos estudos autodidatas, uso NodeJS para arquiteuras MVC (Model view controller) e frameworks de renderização como Angular e React. 
							</p>
		    ...
		    <section class="testimonial-area section-gap">
		        <div class="container">
		            <div class="row d-flex justify-content-center">
		                <div class="menu-content pb-70 col-lg-8">
		                    <div class="title text-center">
		                        <h1 class="mb-10 center">Client’s Feedback About Me</h1>
		                    </div>
		                </div>
		            </div>
		            <div class="row">
		                <div class="active-testimonial">
							...
							<div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="img-fluid" src="img/elements/user3.jpeg" alt="">
		                        </div>
		                        <div class="desc">
		                            <p>
		                                Olá, me chamo Tuanno Danyllo é um prazer poder participar do processo seletivo da empresa Maxisite.
										Espero contribuir e evoluir com o crescimento da empresa.		     
		                            </p>
		                            <h4>Tuanno Danyllo</h4>
		                            <p>Estágiario na Maxisite</p>
		                        </div>
		                    </div>
		                </div>
		            </div>
						...
						<?
							foreach ($planos as $plano) {
								echo '<div class="col-lg-3 col-md-6 single-price">
									<div class="top-part">
										<h1 class="package-no">'.$plano['numero'].'</h1>
										<h4>'.$plano['title'].'</h4>
										<p class="mt-10">'.$plano['subtitulo'].'</p>
									</div>
									<div class="package-list">
										<ul>
											<li>'.$plano['caracteristica1'].'</li>
											<li>'.$plano['caracteristica2'].'</li>
											<li>'.$plano['caracteristica3'].'</li>
										</ul>
									</div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-sm-6">
                            <div class="single-footer-widget">
                                <h4>About Me</h4>
                                <p>
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sit obcaecati explicabo vero nesciunt ab, accusamus voluptatibus. Ad et ea magnam reiciendis enim! Accusantium placeat fugit quo repellat, voluptas natus. Quis?
									<br>
									Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sit obcaecati explicabo vero nesciunt ab, accusamus voluptatibus. Ad et ea magnam reiciendis enim! Accusantium placeat fugit quo repellat, voluptas natus. Quis?
                                </p>
